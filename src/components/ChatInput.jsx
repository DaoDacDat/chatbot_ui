...
function ChatInput({ newMessage, isLoading, setNewMessage, submitNewMessage }) {
  ...
  return(
    <div className='sticky bottom-0 bg-white py-4 rounded-xl mx-auto w-3/5' >
      <div className='p-1.5 bg-white rounded-3xl z-50 font-mono origin-bottom animate-chat duration-400'>
        <div className='pr-0.5 bg-white relative shrink-0 rounded-3xl overflow-hidden ring-primary-blue ring-1 focus-within:ring-2 transition-all mx-auto w-5/6'>
          <textarea
